...
# Add venv site-packages to path (for dependencies like anthropic)
venv_path = Path(__file__).parent.parent.parent.parent / "os" / "venv"
if venv_path.exists():
...
sys.path.insert(0, str(Path(__file__).parent.parent.parent.parent / "os"))
